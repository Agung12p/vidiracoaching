                        ...
                        <form action="" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input readonly type="text" value="<?= $contact->phone ?>" title="Tidak boleh kosong" name="phone" id="phone" class="form-control" placeholder="Nomer Telepon">
                                </div>
                                <div class="form-group mb-3">
        ...
        <div class="modal-content">
            ...
            <form id="contact" action="<?= base_url() ?>admin/contact/update" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="phone">Nomer telepon</label>
                        <input type="text" value="<?= $contact->phone ?>" title="Tidak boleh kosong" name="phone" id="phone" class="form-control" placeholder="Nomer Telepon">
                    </div>
                    <div class="form-group mb-3">
                        <label for="alamat">Alamat Perusahaan</label>
