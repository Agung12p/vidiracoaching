<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>The Eight Money Types ID</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="header" action="<?= base_url() ?>admin/emt/update_header_id" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="profile_form" action="<?= base_url() ?>admin/emt/update_profile_id" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group pt-4">
                                        ...
                                        <input type="text" name="feature" value="<?= $emt->feature_id ?>" class="form-control" placeholder="Header Profile">
                                    </div>
                                    <div class="form-group pt-2">
                                        <label for="konten">Eight Money Types EN</label>
                                        <textarea id="konten" name="konten" class="form-control" placeholder="Profile" rows="14"><?= $emt->sub_feature_id ?></textarea>
                                    </div>
                                </div>
                                    ...
                                    foreach ($type as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/emt/delete_type_id/<?php echo $data->id_type ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/emt/update_bg_id" enctype="multipart/form-data" method="post">
                        ...
                        <form action="<?= base_url() ?>admin/emt/update_header_feature_id" enctype="multipart/form-data" method="post">

                            <div class="form-group ">
                                <input type="hidden" id="id" name="id" value="<?= $header_feature->id_feature ?>">
                                <label for="header">Header Feature ID</label>
                                <input type="text" name="header" value="<?= $header_feature->header ?>" class="form-control" placeholder="Header Profile">
                            </div>
                            <div class="form-group pt-2">
                                <label for="konten">Sub Header Feature ID</label>
                                        ...
                                        foreach ($feature as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/emt/delete_feature_id/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
...
<script>
    ...
    function edit_feature(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/emt/ajax_feature_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function edit_type(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/emt/ajax_type_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/emt/add_type_id" method="post">
...
<div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form1" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/emt/update_type_id" method="post">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/emt/add_feature_id" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" name="header" class="form-control" id="header">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/emt/update_feature_id" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
