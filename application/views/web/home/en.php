            ...
            <nav class="navbar navbar-expand-lg navbar-light text-uppercase font-weight-bold">
                ...
                <div class="collapse navbar-collapse" id="navigation">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link rounded" href="<?= base_url() ?>en">Home</a></li>
                        ...
                        <li id="ocs1" class="nav-item dropdown">
                            ...
                            <div id="ocs2" class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <ul style="list-style-type: none;">
                                    <li class="">
                                        <a class="dropdown-item px-5" href="<?= base_url() ?>financial-planning">Financial Planning</a>
                                        <a class="dropdown-item px-5" href="<?= base_url() ?>money-coaching">Money Coaching</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
