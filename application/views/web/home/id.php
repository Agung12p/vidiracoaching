...
<body id="body">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-left">
                                <h1 style="color:<?= $data->color ?>; font-size: <?= $data->font_size ?>px; line-height:1.3 ; text-shadow: black 0.1em 0.1em 0.2em;" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1"><?= $data->masthead_id ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="service-2 section pb-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="display-6" style="font-family: title;font-weight: normal;"><?= $feature->header ?></h2>
    ...
    <section class="section py-0" id="ocs">
        <div class="container">
            ...
            <h2 class="display-6 text-center" style="font-weight: normal;"><?= $header_feature2->header ?></h2>
            ...
            <div class="container">
                <div class="row text-white">
                    ...
                    <div class="col-lg-3 mt-3 ">
                        ...
                        <form id="subs" action="<?= base_url() ?>contact/subs/id" method="post">
                            <div class="row mt-3">
                                <div class="col-md-9">
