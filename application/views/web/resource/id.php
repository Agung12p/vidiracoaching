        ...
        <div class="row mt-2">
            <div class="col-md-8">
                <div class="container px-0">
                    <div class="row">
                        <?php foreach ($resource_id as $data) { ?>
                                ...
                                <a href="<?= base_url() ?>id/artikel/<?= $data->slug ?>">
                                    <div class="card text-white" style="max-width: 600px;">
                                        ...
                                        <div class="card-img-overlay" style="background-color: rgba(0, 0, 0, 0.3)">
                                            <h1 class="text-center mt-5 pt-5"><?= $data->judul ?></h1>
                                            <p class="card-text text-center"><?= date('d F Y', strtotime($data->tanggal_post)); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="container">
                    ...
                    <?php foreach ($recent as $data) { ?>
                        <div class="cardborder-0 mt-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="<?= base_url() ?>id/artikel/<?= $data->slug ?>">
                                        <img src="<?= base_url() ?>assets/assets/blog/<?= $data->img ?>" class="card-img" alt="..."></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="container">
                        <div class="pp-category-filter">
                            <div class="row">
                                <div class="col-md-12">
                                    <a style="color: black; background:white" class="rounded btn btn-warning pp-filter-button" href="#" data-filter="all">Semua</a>
                                    <?php foreach ($kategori as $data) { ?>
                                        <a style="color: black; background:white" class="rounded btn btn-outline-warning pp-filter-button" href="#" data-filter="<?= $data->nama_kategori ?>"><?= $data->nama_kategori ?>
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
