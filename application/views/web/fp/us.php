    ...
    <div class="container">
        <div class="row h-100 align-items-center py-5">
            <div class="col-lg-6">
                ...
                <p style="font-size: 20px; " class="text-left mb-0"><?= $header_feature->konten ?></p>
    ...
    <div class="container">
        <div class="row h-100 align-items-center py-5">
            ...
            <div class="col-lg-6 mt-5">
                ...
                <a href="<?= base_url() ?>artikel/sandwich-generation" class="btn btn-outline-warning px-5 rounded-pill shadow-sm mt-5 ">Learn More</a>
            </div>
        </div>
        <hr>
    </div>
    <div class="container">
        <div class="row h-100">
            ...
            <div class="col-lg-6 mt-4">
                <p style="font-size: 20px; " class="text-left mb-0"><?= $header_feature3->konten ?></p>
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-md-4 border-right">
                        ...
                        <?php
                        if ($i == 1) { ?>
                            <a href="<?= base_url() ?>artikel/inflation" class="btn btn-outline-light mt-5 text-warning">LEARN MORE</a>
                        <?php } elseif ($i == 2) { ?>
                            <a href="<?= base_url() ?>artikel/compounding-interest" class="btn btn-outline-light mt-5 text-warning">LEARN MORE</a>
                        <?php } elseif ($i == 3) { ?>
                            <a href="<?= base_url() ?>artikel/risk-reward" class="btn btn-outline-light mt-5 text-warning">LEARN MORE</a>
                        <?php }
                        ?>
                    </div>
                <?php   } ?>
