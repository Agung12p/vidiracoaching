...
<section class=" text-black mb-0 test">
    <div class="container">
        <div class="row h-100">
            <div class="col-lg-6">
                <h1 class="display-4"><?= $ocs->feature_id ?></h1>
                <p style="font-size: large;" class="text-left mb-0"><?= $ocs->sub_feature_id ?></p>
                <a href="<?= base_url() . $this->uri->segment(1)  ?>/contact" class="btn btn-outline-warning px-5 rounded-pill shadow-sm mt-5 ">MULAI</a>
            </div>
            <div class="col-lg-6 pt-5 mt-5 d-lg-block"><img src="<?= base_url() ?>assets/assets/img/<?= $ocs->img_feature ?>" alt="" class="img-fluid"></div>
        </div>
        <hr>
    </div>
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-md-4 border-right border-left">
                        ...
                        <?php
                        if ($i == 1) { ?>
                            <a href="<?= base_url() . $this->uri->segment(1)  ?>/financial-planning" class="btn btn-outline-light mt-5 text-warning">PELAJARI LEBIH</a>
                        <?php } elseif ($i == 2) { ?>
                            <a href="<?= base_url() . $this->uri->segment(1)  ?>/money-coaching" class="btn btn-outline-light mt-5 text-warning">PELAJARI LEBIH</a>
                        <?php } elseif ($i == 3) { ?>
                            <a href="<?= base_url() . $this->uri->segment(1)  ?>/eight-money-types" class="btn btn-outline-light mt-5 text-warning">PELAJARI LEBIH</a>
                        <?php }
                        ?>
                    </div>
                <?php } ?>
